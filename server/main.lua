...
RegisterNetEvent('qb-apartments:server:SetInsideMeta', function(house, insideId, bool, isVisiting)
    ...
    if bool then
        ...
        exports['qb-core']:SetPlayerBucket(src, tonumber(routeId))
    else
        ...
        Player.Functions.SetMetaData('inside', insideMeta)
        exports['qb-core']:SetPlayerBucket(src, 0)
    end
end)
...
exports['qb-core']:CreateCallback('apartments:GetAvailableApartments', function(_, cb, apartment)
    local apartments = {}
...
exports['qb-core']:CreateCallback('apartments:GetApartmentOffset', function(_, cb, apartmentId)
    local retval = 0
...
exports['qb-core']:CreateCallback('apartments:GetApartmentOffsetNewOffset', function(_, cb, apartment)
...
exports['qb-core']:CreateCallback('apartments:GetOwnedApartment', function(source, cb, cid)
    if cid ~= nil then
...
exports['qb-core']:CreateCallback('apartments:IsOwner', function(source, cb, apartment)
    local src = source
    local Player = exports['qb-core']:GetPlayer(src)
    if not Player then
        return cb(false)
...
exports['qb-core']:CreateCallback('apartments:GetOutfits', function(source, cb)
    local src = source
    local Player = exports['qb-core']:GetPlayer(src)
